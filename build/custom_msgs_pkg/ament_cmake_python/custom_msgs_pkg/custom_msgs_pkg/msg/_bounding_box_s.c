...
bool custom_msgs_pkg__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs_pkg.msg._bounding_box.BoundingBox", full_classname_dest, 45) == 0);
  }
  custom_msgs_pkg__msg__BoundingBox * ros_message = _ros_message;
  {  // x1
...
PyObject * custom_msgs_pkg__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs_pkg.msg._bounding_box");
