...
#ifndef CUSTOM_MSGS_PKG__MSG__DETAIL__BOUNDING_BOX__TRAITS_HPP_
#define CUSTOM_MSGS_PKG__MSG__DETAIL__BOUNDING_BOX__TRAITS_HPP_
...
inline void to_yaml(
  const custom_msgs_pkg::msg::BoundingBox & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const custom_msgs_pkg::msg::BoundingBox & msg)
{
  return custom_msgs_pkg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<custom_msgs_pkg::msg::BoundingBox>()
{
  return "custom_msgs_pkg::msg::BoundingBox";
}

template<>
inline const char * name<custom_msgs_pkg::msg::BoundingBox>()
{
  return "custom_msgs_pkg/msg/BoundingBox";
}

template<>
struct has_fixed_size<custom_msgs_pkg::msg::BoundingBox>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<custom_msgs_pkg::msg::BoundingBox>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<custom_msgs_pkg::msg::BoundingBox>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CUSTOM_MSGS_PKG__MSG__DETAIL__BOUNDING_BOX__TRAITS_HPP_
