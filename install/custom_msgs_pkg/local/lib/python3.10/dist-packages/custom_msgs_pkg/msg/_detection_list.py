    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs_pkg.msg.DetectionList')
            logger.debug(
            ...
            from custom_msgs_pkg.msg import BoundingBox
...
class DetectionList(metaclass=Metaclass_DetectionList):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<custom_msgs_pkg/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['custom_msgs_pkg', 'msg'], 'BoundingBox')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'detections' field must be a set or sequence and each value of type 'BoundingBox'"
